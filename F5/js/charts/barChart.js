var data = [215, 499, 185, 8, 74, 30, 141, 380, 148, 273, 434, 186, 398, 260, 288, 228, 326, 236, 310, 435, 20, 232, 124, 233],
    margin = { top: 20, right: 20, bottom: 30, left: 40 },
    width = $('.bar-chart').parent().width(),
    height = $('.bar-chart').parent().height();
